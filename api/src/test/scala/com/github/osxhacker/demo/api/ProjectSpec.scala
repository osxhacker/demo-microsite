package com.github.osxhacker.demo.api
...
trait ProjectSpec
	extends AnyWordSpec
		with ProjectScalacheckImplicits
{
	/// Class Imports
	 ...
	 * instances for [[com.github.osxhacker.demo.api]] types which
	 * [[eu.timepit.refined.scalacheck]] cannot reasonably generate (usually
	 * due to
